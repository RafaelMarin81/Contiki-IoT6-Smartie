...
static int compareWavePeaksHeight(const struct WavePeak w1, const struct WavePeak w2)
{
...
/*---------------------------------------------------------------------------*/
//devuelve verdadero si el primero es menor que el segundo
static int compareWavePeaksPosition(const struct WavePeak w1, const struct WavePeak w2){
...
static int partition(struct WavePeak a[], int l, int r)
{
