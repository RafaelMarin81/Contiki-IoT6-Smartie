...
void MD5Init (MD5_CTX *mdContext)
{
   ...
   */
  mdContext->buf[0] = (unsigned long)0x67452301;
  mdContext->buf[1] = (unsigned long)0xefcdab89;
  mdContext->buf[2] = (unsigned long)0x98badcfe;
  mdContext->buf[3] = (unsigned long)0x10325476;
}
