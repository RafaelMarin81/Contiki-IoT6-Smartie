...
static uint16_t server_received_last_PRR = 0;
...
*/
        ...
        server_received_last_PRR = table_datalog[server_received_datalog.num_sec][server_received_datalog.power]; 
/*        seq++;      // Increase sequence for Sleep mode.
        ...
        server_received_datalog.num_paq = server_received_last_PRR;
